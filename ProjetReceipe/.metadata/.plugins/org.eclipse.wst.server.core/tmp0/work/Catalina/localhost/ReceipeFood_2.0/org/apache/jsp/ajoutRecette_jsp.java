 ...
 * Generated at: 2017-05-12 14:05:46 UTC
...
public final class ajoutRecette_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("    <link rel=\"stylesheet\" href=\"/ReceipeFood_2.0/css/style_Add.css\" charset=\"utf-8\">\r\n");
 ...
 if(request.getAttribute("error")!=null){ 
      ...
      out.write("\t\t\t  <strong>Produit non ajoutÃ©!</strong>   ");
 out.println(request.getAttribute("error")); 
      ...
      out.write("\t\t\t\t\t<h1>Ajouter votre nouvelle recette</h1>\r\n");
      out.write("\t\t\t\t\t<form action=\"detailAjout\" class=\"form-horizontal\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"produit.nom\" placeholder=\"Nom du plat\" onblur=\"this.value=!this.value?'Nom':this.value;\" onfocus=\"this.select()\" onclick=\"this.value='';\">\r\n");
      out.write("\t\t\t\t\t\t<select class=\"icons\" name=\"idCategorie\"  required>\r\n");
      out.write("\t\t\t\t\t        <option value=\"1\" disabled selected>Choisissez une categorie</option>\r\n");
      out.write("\t\t\t\t\t      ");
 ...
 out.print(c.getNom()); 
      ...
      out.write("\t\t\t\t\t      </select>\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("                      <textarea name=\"produit.etape\" class=\"textarea\" placeholder=\"Etapes &agrave; suivre\" style=\"width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;\"></textarea>\r\n");
      out.write("                    </div>\r\n");
      out.write("\t\t\t\t\t\t<!-- <textarea name=\"produit.etape\" class=\"textarea\" cols=\"50\" rows=\"7\">Decrire les Ã©tapes Ã  suivre...</textarea> -->\r\n");
      out.write("\t\t\t\t\t\t<label>SÃ©parer chaque composant d'un point virgule (\";\")</label>\r\n");
      out.write("\t\t\t\t\t\t<textarea name=\"listeComposant\" cols=\"50\" rows=\"7\">fromage;lait;tomate</textarea>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"Suivant\" id=\"submit\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"section\">\r\n");
      out.write("\t\t\t\t\t<h1>ON AIMERIEZ QUE VOUS PARTAGIEZ VOS RECETTES!</h1>\r\n");
      out.write("\t\t\t\t\t<p>If you're having problems editing this website template, then don't hesitate to ask for help on the Forums.</p>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
